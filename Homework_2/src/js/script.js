    ...
    fetch('res/json/posts.json')
        ...
        .then(json => {
            ...
            for (const i in json){
                ...
                post_head.innerHTML = '<a><img id="profile_pic" src="res/images/me.png" width="40" height="40" alt="My picture"></a>';
                ...
                post_footer.innerHTML = '<button type="submit" class="like_button" id="like_button"><img src="res/images/like_button.png" width="40" height="40" alt="Like" /></button><p>Likes: '+ json[i].likes +'</p> <p>Comments:'+ json[i].comments +'</p>'
